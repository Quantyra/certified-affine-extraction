...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySupportBlockSize_eq_pow_pred_of_vars_ne_empty` | `propext` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySupportBlockSize_pos_of_vars_ne_empty` | `propext` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.clausesForVertex_length_eq_generatedParitySupportBlockSize` | `propext`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.sortClauseFingerprints_count_eq` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.mem_canonicalBlockFingerprint_append_iff` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.canonicalBlockFingerprint_count_append` | `propext`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_decomposition_cover_toSyntacticOk` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_recoverSameSupportGroupWithDirectChargeFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_recoverSameSupportGroupWithDirectBlockSizeFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_recoverSameSupportGroupWithDirectInferredBlockSizeFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_recoverSameSupportGroupWithChargeSearchFallback` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.semanticPreservation_of_recoverSameSupportGroupWithChargeSearchFallback` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.splitCanonicalSupportClauseGroupsWithNonexhaustiveFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.splitCanonicalSupportClauseGroupsWithNonexhaustiveFallback_expandedCNF_perm` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback_expandedCNF_perm` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback_syntacticSignals_append` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback_toSyntacticOk_append` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.semanticPreservation_of_splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback_toSyntacticOk_append` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.NonexhaustiveExtractorCompleteOn` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.NonexhaustiveSemanticExtractorCompleteOn` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.nonexhaustiveExtractorCompleteOn_of_splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.nonexhaustiveSemanticExtractorCompleteOn_of_class` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.nonexhaustiveSemanticExtractorCompleteOn_of_splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback_toSyntacticOk_append` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.nonexhaustiveSemanticExtractorCompleteOn_of_splitArityFourParityCanonicalSupportGroupsWithNonexhaustiveFallback_toSyntacticOk` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.enhancedSemanticExtractorCompleteOn_of_singleGroupChargeSearchFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.enhancedSemanticExtractorCompleteOn_of_singleGroupNonexhaustiveFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.nonexhaustiveSemanticExtractorCompleteOn_of_singleGroupNonexhaustiveFallback` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.enhancedSemanticExtractorCompleteOn_exists_of_perm_generatedParitySpecs_sameSupport` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.nonexhaustiveSemanticExtractorCompleteOn_exists_of_perm_generatedParitySpecs_sameSupport` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_exists_coreTarget_gf2Equiv_of_perm_supportCharges_componentBound` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_exists_certifiedCoreTarget_gf2Equiv_of_perm_supportCharges_componentBound` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithNonexhaustiveFallback_exists_certifiedCoreTarget_gf2Equiv_of_perm_supportCharges` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithNonexhaustiveFallback_sound` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithNonexhaustiveFallback_sound_coreGF2` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithNonexhaustiveFallback_toSyntacticOk` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_eq_some_of_nonexhaustive` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.class_of_recoverSameSupportGroupWithNonexhaustiveFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.semanticPreservation_of_recoverSameSupportGroupWithNonexhaustiveFallback` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsGF2_forSupportCharges_eq_map` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsGF2_forSupportCharges_perm_of_charges_perm` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.gf2Sat_generatedParitySpecsForSupportCharges_directTargetCharges_supportSize_iff_of_perm_supportCharges` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.gf2Sat_generatedParitySpecsForSupportCharges_directTargetCharges_arityThree_iff_of_perm_supportCharges` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.gf2Sat_generatedParitySpecsForSupportCharges_directTargetCharges_arityFour_iff_of_perm_supportCharges` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.target_length_eq_charge_count_mul_block_length_of_perm_generatedParitySpecsForSupportCharges` | `propext` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.charges_length_eq_target_length_div_block_length_of_perm_generatedParitySpecsForSupportCharges` | `propext` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.target_length_mod_block_length_eq_zero_of_perm_generatedParitySpecsForSupportCharges` | `propext` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.canonicalBlocksFromGeneratedParitySpecs_spec_charges_eq` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.canonicalBlocksFromGeneratedParitySpecs_forSupportCharges_spec_charges_eq` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.canonicalBlocksFromGeneratedParitySpecs_forSupportCharges_spec_charges_count_true` | `propext`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.allFalseClauseFingerprint_count_canonicalBlockFingerprint_clausesForVertex_true_eq_one` | `propext`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.allFalseClauseFingerprint_count_true_le_canonicalBlockFingerprint_generatedParitySpecsCNF_forSupportCharges` | `propext`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.directSameSupportChargesFromTargetWithBlockSize_perm_of_perm_supportCharges_of_block_length` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.directSameSupportChargesFromTargetWithBlockSize_perm_of_perm_supportCharges_supportSize` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGeneratedParityChargesPerm_eq_some_of_directTargetCharges_of_block_length` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSingleMergedSupportGroupFromChargesPerm_eq_some_of_directTargetCharges_of_block_length` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithDirectBlockSizeFallback_eq_some_of_directTargetCharges_of_block_length` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithDirectInferredBlockSizeFallback_eq_some_of_directTargetCharges_supportSize` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithDirectInferredBlockSizeFallback_eq_some_gf2Equiv_of_perm_supportCharges_supportSize` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithDirectChargeFallback_eq_some_of_directTargetCharges_arityThree` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithDirectChargeFallback_eq_some_of_directTargetCharges_arityFour` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_eq_some_of_directTargetCharges_arityThree_of_twoCharge_none` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_eq_some_of_directTargetCharges_arityFour_of_twoCharge_none` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_certifiedDirectArityThree_gf2Equiv_of_perm_supportCharges_of_twoCharge_none` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_certifiedDirectArityFour_gf2Equiv_of_perm_supportCharges_of_twoCharge_none` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_eq_some_of_directTargetCharges_supportSize_of_twoCharge_none_of_directCharge_none` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_certifiedDirectInferred_gf2Equiv_of_perm_supportCharges_of_twoCharge_none_of_directCharge_none` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_eq_nonexhaustive_of_perm_supportCharges` | `propext`, `Classical.choice`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.recoverSameSupportGroupWithChargeSearchFallback_eq_nonexhaustiveFallback_of_perm_supportCharges` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsGF2_forSupportCharges_rhs_eq` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsGF2_forSupportCharges_rhs_count_true` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsGF2_forSupportCharges_rhs_count_false` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_coreGF2_rhs_eq` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_coreGF2_rhs_count_true` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_coreGF2_rhs_count_false` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_block_charges_eq` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_block_charges_count_true` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_block_charges_count_false` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_allFalseFingerprint_signals_eq` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_allFalseFingerprint_count_true` | `propext`, `Quot.sound` |
| `CertifiedAffine.TseitinCNFData.AtomicClassBridge.generatedParitySpecsFallbackDecomposition_forSupportCharges_allFalseFingerprint_count_false` | `propext`, `Quot.sound` |
